...
function SecondFooterComponent() {
  return (
      ...
      <>
      <Box className='bg-dark text-light main-footer' paddingBottom={4} paddingTop={6}>
<Container>
<Grid container >
      <Grid item xs={4}>
        <Typography 
      ...
      <Grid container marginTop={3}>
        <Grid item xs={4} marginX={1} >
          <img src='./assets/play-store.png' className='w-100' />
        </Grid>
        <Grid item xs={4} marginX={1} >
          <img src='./assets/app-store.png' className='w-100' />
        ...
        <Grid item xs={4} textAlign='center'>
          <Box marginBottom={1}>
          <img src="./assets/logo-white.png" className='w-50' />
          </Box>
        <Typography
        variant='body'
        color='GrayText'
