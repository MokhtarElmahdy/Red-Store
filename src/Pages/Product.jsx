...
const ShowProduct = () =>{
  return(
    ...
    <Grid item md={6}>
        <Typography variant='h3' textTransform='uppercase' color='GrayText' >{product.category}</Typography>
        ...
        <Typography variant='h5' my={4} fontWeight='bold'> $ {product.price} </Typography>
        <Typography variant='p' component='p'> {product.description}</Typography>
        <Button paddingX={4} paddingY={2} variant='outlined'> Add to Cart</Button>
        <NavLink to='/cart'>
        <Button paddingX={3} paddingY={2} variant='outlined'> 
          Go to Cart
        </Button>
        </NavLink>
